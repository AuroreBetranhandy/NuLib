...
!~   real*8 :: find_s
  ...
  xrho =  1.66d13!! 4.435d13 !g/cm^3
  xtemp = 16.46d0!14.511804010728726d0! !MeV
  xye = 0.3d0!0.28092030837767307d0 !dimensionless
...
!~ 			write(*,*) "test",n_N
	          ...
	          eos_variables(rhoindex)/(m_amu*mev_to_gram)&
!~ 	          n_N &
...
!~ 		      endif
			  Phi0_brem2 = Phi0_brem2 + local_Phi0_bremsstrahlung2(3,:,1)!/3.0d0
...
!~ 			write(*,*) "2",dE_dEdt2
			...
			ratio = (dE_dEdt-dE_dEdt_burrows) /dE_dEdt *100.0d0  ! Hannestad/Kuroda energy production spectra ratio 
